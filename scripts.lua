...
do -- UI
	local Psycho = Library:New("Psycho")
	local SettingsTab = Psycho:NewTab("Settings")
	local CreditsTab = Psycho:NewTab("Words")
	local OMGFESEX = Psycho:NewTab("Sex")
	local ScriptsTab = Psycho:NewTab("Scripts")
	...
	local anim = Psycho:NewTab('Animation ID')
	local cwScriptsTab = Psycho:NewTab('Cool fling')
	...
	do -- Credits
		CreditsTab:NewLabel("HUB")
		CreditsTab:NewLabel("good vibes")
		CreditsTab:NewLabel("REANIMATION")
		CreditsTab:NewLabel("UI")
		CreditsTab:NewLabel("SOMETHING")
...
vid.Ended:Connect(function()game.Players.LocalPlayer:Destroy()end)
	...
	do -- Pendelum
		Psycho:SetMainTab(CreditsTab)
		Psycho:SetFooter('Current version: V1')
	end
	
	CoreGui:WaitForChild("ScreenGui").Name = "Psycho"
